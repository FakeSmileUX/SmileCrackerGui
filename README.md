...
🔺If you have NodeMcu you can use with process for deauth
_____________________
### Contact Me
...
```
$ sudo apt install qt4-dev-tools pyqt4-dev-tools python
$ pip install pyqt4
$ python smilecracker.py
```
_____________________	
...
▪️I will ad support for NodeMcu after better GUI
_____________________
### Languages and Tools:
