...
class Ui_Main_window(object):
    def setupUi(self, Main_window):
        ...
        self.gridlayout.addWidget(self.text_output, 1, 0, 1, 2)
        ...
        self.page1.setGeometry(QtCore.QRect(0, 0, 684, 488))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_User_Interface_1670635.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon)
        self.table_interfaces.setHorizontalHeaderItem(0, item)
        item = QtGui.QTableWidgetItem()
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_Ethernet_542785.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon1)
        self.table_interfaces.setHorizontalHeaderItem(1, item)
        item = QtGui.QTableWidgetItem()
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_chipset_1595437.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon2)
        self.table_interfaces.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../noun_coding_2309592.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon3)
        self.table_interfaces.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_Question_338831.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon4)
        ...
        item = QtGui.QTableWidgetItem()
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_Document_1146377.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon5)
        ...
        item = QtGui.QTableWidgetItem()
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_hashtag_1808612.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon6)
        self.table_networks.setHorizontalHeaderItem(2, item)
        item = QtGui.QTableWidgetItem()
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_signal_2308127.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.table_networks.setHorizontalHeaderItem(3, item)
        item = QtGui.QTableWidgetItem()
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8("gfx/noun_password_1199277.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon8)
        ...
        self.page11.setGeometry(QtCore.QRect(0, 0, 684, 356))
        ...
        spacerItem = QtGui.QSpacerItem(41, 110, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout.addItem(spacerItem)
        self.toolBox2_2.addItem(self.page11, _fromUtf8(""))
        self.page2 = QtGui.QWidget()
        self.page2.setGeometry(QtCore.QRect(0, 0, 467, 374))
        self.page2.setObjectName(_fromUtf8("page2"))
        self.gridlayout6 = QtGui.QGridLayout(self.page2)
        self.gridlayout6.setMargin(11)
        self.gridlayout6.setSpacing(6)
        self.gridlayout6.setObjectName(_fromUtf8("gridlayout6"))
        spacerItem1 = QtGui.QSpacerItem(41, 20, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridlayout6.addItem(spacerItem1, 3, 0, 1, 1)
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 276, 530))
        ...
        spacerItem2 = QtGui.QSpacerItem(41, 20, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout5.addItem(spacerItem2)
        self.toolBox2_2.addItem(self.page, _fromUtf8(""))
        self.page1 = QtGui.QWidget()
        self.page1.setGeometry(QtCore.QRect(0, 0, 310, 255))
        self.page1.setObjectName(_fromUtf8("page1"))
        self.vboxlayout9 = QtGui.QVBoxLayout(self.page1)
        self.vboxlayout9.setMargin(11)
        ...
        self.vboxlayout12.setMargin(11)
        ...
        spacerItem3 = QtGui.QSpacerItem(41, 111, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout9.addItem(spacerItem3)
        ...
        self.vboxlayout14.setMargin(11)
        ...
        spacerItem4 = QtGui.QSpacerItem(41, 140, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout13.addItem(spacerItem4)
        self.toolBox4_2.addItem(self.page21, _fromUtf8(""))
        self.page2 = QtGui.QWidget()
        self.page2.setGeometry(QtCore.QRect(0, 0, 497, 272))
        self.page2.setObjectName(_fromUtf8("page2"))
        self.vboxlayout16 = QtGui.QVBoxLayout(self.page2)
        self.vboxlayout16.setMargin(11)
        ...
        spacerItem5 = QtGui.QSpacerItem(20, 80, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout16.addItem(spacerItem5)
        ...
        self.toolBox4_3 = QtGui.QToolBox(self.tab_2)
        self.toolBox4_3.setGeometry(QtCore.QRect(10, 18, 641, 501))
        self.toolBox4_3.setObjectName(_fromUtf8("toolBox4_3"))
        self.page2_2 = QtGui.QWidget()
        self.page2_2.setGeometry(QtCore.QRect(0, 0, 641, 435))
        self.page2_2.setObjectName(_fromUtf8("page2_2"))
        self._2 = QtGui.QVBoxLayout(self.page2_2)
        self._2.setMargin(11)
        self._2.setSpacing(6)
        self._2.setObjectName(_fromUtf8("_2"))
        self.buttonGroup2_2_3 = QtGui.QGroupBox(self.page2_2)
        self.buttonGroup2_2_3.setObjectName(_fromUtf8("buttonGroup2_2_3"))
        self._4 = QtGui.QVBoxLayout(self.buttonGroup2_2_3)
        self._4.setMargin(11)
        self._4.setSpacing(6)
        self._4.setObjectName(_fromUtf8("_4"))
        self.button_wpa_test_inj_2 = QtGui.QPushButton(self.buttonGroup2_2_3)
        self.button_wpa_test_inj_2.setObjectName(_fromUtf8("button_wpa_test_inj_2"))
        self._4.addWidget(self.button_wpa_test_inj_2)
        self.pushButton_2 = QtGui.QPushButton(self.buttonGroup2_2_3)
        self.pushButton_2.setObjectName(_fromUtf8("pushButton_2"))
        self._4.addWidget(self.pushButton_2)
        self._2.addWidget(self.buttonGroup2_2_3)
        spacerItem6 = QtGui.QSpacerItem(41, 140, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self._2.addItem(spacerItem6)
        self.toolBox4_3.addItem(self.page2_2, _fromUtf8(""))
        self.page_2 = QtGui.QWidget()
        self.page_2.setGeometry(QtCore.QRect(0, 0, 593, 391))
        self.page_2.setObjectName(_fromUtf8("page_2"))
        self._5 = QtGui.QVBoxLayout(self.page_2)
        self._5.setMargin(11)
        self._5.setSpacing(6)
        self._5.setObjectName(_fromUtf8("_5"))
        self.groupBox4_3 = QtGui.QGroupBox(self.page_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        ...
        self.groupBox4_3.setMinimumSize(QtCore.QSize(575, 75))
        self.groupBox4_3.setSizeIncrement(QtCore.QSize(200, 200))
        self.groupBox4_3.setBaseSize(QtCore.QSize(200, 200))
        self.groupBox4_3.setObjectName(_fromUtf8("groupBox4_3"))
        self.radioButton = QtGui.QRadioButton(self.groupBox4_3)
        self.radioButton.setGeometry(QtCore.QRect(11, 30, 155, 25))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.radioButton_2 = QtGui.QRadioButton(self.groupBox4_3)
        self.radioButton_2.setGeometry(QtCore.QRect(209, 30, 161, 25))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.radioButton_3 = QtGui.QRadioButton(self.groupBox4_3)
        self.radioButton_3.setGeometry(QtCore.QRect(400, 30, 130, 25))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self._5.addWidget(self.groupBox4_3)
        self.groupBox4_4 = QtGui.QGroupBox(self.page_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(200)
        sizePolicy.setVerticalStretch(100)
        sizePolicy.setHeightForWidth(self.groupBox4_4.sizePolicy().hasHeightForWidth())
        self.groupBox4_4.setSizePolicy(sizePolicy)
        self.groupBox4_4.setMinimumSize(QtCore.QSize(575, 75))
        self.groupBox4_4.setSizeIncrement(QtCore.QSize(200, 200))
        self.groupBox4_4.setBaseSize(QtCore.QSize(200, 200))
        self.groupBox4_4.setObjectName(_fromUtf8("groupBox4_4"))
        self.checkBox = QtGui.QCheckBox(self.groupBox4_4)
        self.checkBox.setGeometry(QtCore.QRect(20, 30, 181, 25))
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.checkBox_2 = QtGui.QCheckBox(self.groupBox4_4)
        self.checkBox_2.setGeometry(QtCore.QRect(199, 30, 120, 25))
        self.checkBox_2.setObjectName(_fromUtf8("checkBox_2"))
        self.checkBox_3 = QtGui.QCheckBox(self.groupBox4_4)
        self.checkBox_3.setGeometry(QtCore.QRect(316, 30, 211, 25))
        self.checkBox_3.setObjectName(_fromUtf8("checkBox_3"))
        self._5.addWidget(self.groupBox4_4)
        self.groupBox4_5 = QtGui.QGroupBox(self.page_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(200)
        sizePolicy.setVerticalStretch(100)
        sizePolicy.setHeightForWidth(self.groupBox4_5.sizePolicy().hasHeightForWidth())
        self.groupBox4_5.setSizePolicy(sizePolicy)
        self.groupBox4_5.setMinimumSize(QtCore.QSize(575, 75))
        self.groupBox4_5.setSizeIncrement(QtCore.QSize(200, 200))
        self.groupBox4_5.setBaseSize(QtCore.QSize(200, 200))
        self.groupBox4_5.setObjectName(_fromUtf8("groupBox4_5"))
        self.checkBox_4 = QtGui.QCheckBox(self.groupBox4_5)
        self.checkBox_4.setGeometry(QtCore.QRect(20, 30, 104, 25))
        self.checkBox_4.setObjectName(_fromUtf8("checkBox_4"))
        self.checkBox_5 = QtGui.QCheckBox(self.groupBox4_5)
        self.checkBox_5.setGeometry(QtCore.QRect(120, 30, 131, 25))
        self.checkBox_5.setObjectName(_fromUtf8("checkBox_5"))
        self.checkBox_6 = QtGui.QCheckBox(self.groupBox4_5)
        self.checkBox_6.setGeometry(QtCore.QRect(228, 30, 104, 25))
        self.checkBox_6.setObjectName(_fromUtf8("checkBox_6"))
        self.checkBox_8 = QtGui.QCheckBox(self.groupBox4_5)
        self.checkBox_8.setGeometry(QtCore.QRect(316, 29, 151, 25))
        self.checkBox_8.setObjectName(_fromUtf8("checkBox_8"))
        self.checkBox_7 = QtGui.QCheckBox(self.groupBox4_5)
        self.checkBox_7.setGeometry(QtCore.QRect(474, 30, 70, 25))
        self.checkBox_7.setObjectName(_fromUtf8("checkBox_7"))
        self._5.addWidget(self.groupBox4_5)
        self.groupBox4_6 = QtGui.QGroupBox(self.page_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(200)
        ...
        self.groupBox4_6.setMinimumSize(QtCore.QSize(575, 130))
        self.groupBox4_6.setSizeIncrement(QtCore.QSize(200, 200))
        self.groupBox4_6.setBaseSize(QtCore.QSize(200, 200))
        self.groupBox4_6.setObjectName(_fromUtf8("groupBox4_6"))
        self.radioButton_7 = QtGui.QRadioButton(self.groupBox4_6)
        self.radioButton_7.setGeometry(QtCore.QRect(20, 31, 171, 25))
        self.radioButton_7.setObjectName(_fromUtf8("radioButton_7"))
        self.radioButton_8 = QtGui.QRadioButton(self.groupBox4_6)
        self.radioButton_8.setGeometry(QtCore.QRect(210, 30, 191, 25))
        self.radioButton_8.setObjectName(_fromUtf8("radioButton_8"))
        self.radioButton_9 = QtGui.QRadioButton(self.groupBox4_6)
        self.radioButton_9.setGeometry(QtCore.QRect(399, 30, 161, 25))
        self.radioButton_9.setObjectName(_fromUtf8("radioButton_9"))
        self.pushButton = QtGui.QPushButton(self.groupBox4_6)
        self.pushButton.setGeometry(QtCore.QRect(20, 74, 151, 40))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self._5.addWidget(self.groupBox4_6)
        self.toolBox4_3.addItem(self.page_2, _fromUtf8(""))
        ...
        self.vboxlayout19.setMargin(11)
        ...
        self.pushButton_3 = QtGui.QPushButton(self.page12)
        self.pushButton_3.setEnabled(False)
        self.pushButton_3.setObjectName(_fromUtf8("pushButton_3"))
        self.vboxlayout18.addWidget(self.pushButton_3)
        spacerItem7 = QtGui.QSpacerItem(21, 20, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout18.addItem(spacerItem7)
        ...
        self.gridlayout10.setMargin(11)
        ...
        self.vboxlayout21.setMargin(11)
        ...
        spacerItem8 = QtGui.QSpacerItem(31, 91, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.vboxlayout20.addItem(spacerItem8)
        self.toolBox5_3.addItem(self.page13, _fromUtf8(""))
        self.page22 = QtGui.QWidget()
        self.page22.setGeometry(QtCore.QRect(0, 0, 684, 386))
        ...
        self.vboxlayout22.setMargin(11)
        ...
        spacerItem9 = QtGui.QSpacerItem(31, 200, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridlayout11.addItem(spacerItem9, 2, 0, 1, 1)
        ...
        self.vboxlayout23.setMargin(11)
        ...
        self.page3.setGeometry(QtCore.QRect(0, 0, 684, 356))
        self.page3.setObjectName(_fromUtf8("page3"))
        self.gridlayout12 = QtGui.QGridLayout(self.page3)
        self.gridlayout12.setMargin(11)
        self.gridlayout12.setSpacing(6)
        self.gridlayout12.setObjectName(_fromUtf8("gridlayout12"))
        spacerItem10 = QtGui.QSpacerItem(31, 101, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridlayout12.addItem(spacerItem10, 1, 0, 1, 1)
        ...
        self.vboxlayout24.setMargin(11)
        ...
        self.toolBox5_3.addItem(self.page_4, _fromUtf8(""))
        self.page_3 = QtGui.QWidget()
        self.page_3.setGeometry(QtCore.QRect(0, 0, 98, 28))
        self.page_3.setObjectName(_fromUtf8("page_3"))
        self.toolBox5_3.addItem(self.page_3, _fromUtf8(""))
        self.gridlayout10.addWidget(self.toolBox5_3, 0, 0, 1, 1)
        ...
        self.gridlayout13.setMargin(11)
        ...
        spacerItem11 = QtGui.QSpacerItem(51, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.hboxlayout6.addItem(spacerItem11)
        ...
        spacerItem13 = QtGui.QSpacerItem(41, 140, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        ...
        self.toolBox4_3.setCurrentIndex(0)
    ...
    def retranslateUi(self, Main_window):
        Main_window.setWindowTitle(_translate("Main_window", "smile wifi cracker", None))
        self.textLabel1.setText(_translate("Main_window", "<html><head/><body><p><span style=\" font-weight:600;\">Hello and Welcome!</span><br/>Smile Wifi Cracker is a Gui for wifi penetration testing.</p><p><br/></p><p><span style=\" font-weight:600;\">TODO:</span></p><p>* Convert from pyqt4 to pyqt5</p><p>* Convert from python3</p><p><br/></p><p>Feel free\'project!<br/><a href=\"https://github.com/FakeSmile/SmileCrackerGui\"><span style=\" text-decoration: underline; color:#0000ff;\">Check my GitHub repo</span></a> and tag along</p><p><br/></p><p><br/>Generated.<br/>Also, thanks for everything th &amp; FakeSmile</p><p><br/><span style=\" font-size:10pt; font-weight:600;\">This app uses 3rd-party tools in order to work!<br/>aircrack-ng, reaver, pixiewps &amp; xterm needs to be installed.</span></p></body></html>", None))
        ...
        self.textLabel4_4_3.setText(_translate("Main_window", "<html><head/><body><h2 style=\" margin-top:16px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:x-large; font-weight:600;\">WEP Sniffing / Attacks</span></h2></body></html>", None))
        self.tabWidget2.setTabText(self.tabWidget2.indexOf(self.TabPage1), _translate("Main_window", "WEP", None))
        self.textLabel4_4_2_3.setText(_translate("Main_window", "<html><head/><body><h2 style=\" margin-top:16px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:x-large; font-weight:600;\">WPA/WPA2 Sniffing &amp; Attacks</span></h2></body></html>", None))
        ...
        self.buttonGroup2_2_3.setTitle(_translate("Main_window", "Tests", None))
        self.button_wpa_test_inj_2.setText(_translate("Main_window", "Performs a test of injection AP", None))
        self.pushButton_2.setText(_translate("Main_window", "Perform a Bully WPS test", None))
        self.toolBox4_3.setItemText(self.toolBox4_3.indexOf(self.page2_2), _translate("Main_window", "General functionalities", None))
        self.groupBox4_3.setTitle(_translate("Main_window", "Choose verbose level", None))
        self.radioButton.setText(_translate("Main_window", "Minimal verbose", None))
        self.radioButton_2.setText(_translate("Main_window", "Medium verbose", None))
        self.radioButton_3.setText(_translate("Main_window", "Full verbose", None))
        self.groupBox4_4.setTitle(_translate("Main_window", "Reaver options", None))
        self.checkBox.setText(_translate("Main_window", "Use small DH keys", None))
        self.checkBox_2.setText(_translate("Main_window", "Ignore FCS", None))
        self.checkBox_3.setText(_translate("Main_window", "Mimic a Win7 registrar", None))
        self.groupBox4_5.setTitle(_translate("Main_window", "Bully options", None))
        self.checkBox_4.setText(_translate("Main_window", "No ACKs", None))
        self.checkBox_5.setText(_translate("Main_window", "No Check", None))
        self.checkBox_6.setText(_translate("Main_window", "No FCS", None))
        self.checkBox_8.setText(_translate("Main_window", "Sequential pins", None))
        self.checkBox_7.setText(_translate("Main_window", "Force", None))
        self.groupBox4_6.setTitle(_translate("Main_window", "Choose attack method / vector", None))
        self.radioButton_7.setText(_translate("Main_window", "Reaver PIN Attack", None))
        self.radioButton_8.setText(_translate("Main_window", "Bully PIN Attack", None))
        self.radioButton_9.setText(_translate("Main_window", "PixieDust Attack", None))
        self.pushButton.setText(_translate("Main_window", "Launch attack!", None))
        self.toolBox4_3.setItemText(self.toolBox4_3.indexOf(self.page_2), _translate("Main_window", "WPS Attacks", None))
        self.tabWidget2.setTabText(self.tabWidget2.indexOf(self.tab_2), _translate("Main_window", "WPS", None))
        self.textLabel4_4_2_3_2.setText(_translate("Main_window", "<html><head/><body><h2 style=\" margin-top:16px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:x-large; font-weight:600;\">Fake Access Point Control Panel</span></h2></body></html>", None))
        ...
        self.pushButton_3.setText(_translate("Main_window", "Stop Fake Access Point", None))
        ...
        self.toolBox5_3.setItemText(self.toolBox5_3.indexOf(self.page_4), _translate("Main_window", "WPA John The Ripper", None))
        self.toolBox5_3.setItemText(self.toolBox5_3.indexOf(self.page_3), _translate("Main_window", "WPA Hashcat cracking", None))
        self.tabWidget2.setTabText(self.tabWidget2.indexOf(self.TabPage4), _translate("Main_window", "Cracking", None))
        self.textLabel4.setText(_translate("Main_window", "<html><head/><body><h2 style=\" margin-top:16px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:x-large; font-weight:600;\">Password Database</span></h2></body></html>", None))
        ...
        self.textLabel14.setText(_translate("Main_window", "<html><head/><body><p>Developers</p></body></html>", None))
        self.textLabel16.setText(_translate("Main_window", "Emanuele Gentili - emgent@backtrack-linux.org\n"
"FakeSmile - t.me/FakeSmile"
"+Penetration Tester and Software Engineer"
"+Android App Developer"
"+Humanity is overrated...", None))
